                ...
                <div className={'pricer-container'}>
                    <div className={'checkbox-row'}>
                        ...
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showPut" checked={this.props.showPut === true} onChange={(event: any) => this.props.setShowPutOnState(event.target.checked)} />
                            Put
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showCall" checked={this.props.showCall === true} onChange={(event: any) => this.props.setShowCallOnState(event.target.checked)} />
                            Call
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showSell" checked={this.props.showSell === true} onChange={(event: any) => this.props.setShowSellOnState(event.target.checked)} />
                            Sell
                        </label>
                    </div>
                    <div className={'checkbox-row'}>
                        <label className={'checkboxGroupLabel'}>Show:</label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showVega" checked={this.props.showVega === true} onChange={(event: any) => this.props.setShowVegaOnState(event.target.checked)} />
                            Vega
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showGamma" checked={this.props.showGamma === true} onChange={(event: any) => this.props.setShowGammaOnState(event.target.checked)} />
                            Gama
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showDelta" checked={this.props.showDelta === true} onChange={(event: any) => this.props.setShowDeltaOnState(event.target.checked)} />
                            Delta
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showTheta" checked={this.props.showTheta === true} onChange={(event: any) => this.props.setShowThetaOnState(event.target.checked)} />
                            Theta
                        </label>
                        <label className={'checkboxLabel'}>
                            <input type="checkbox" value="showRho" checked={this.props.showRho === true} onChange={(event: any) => this.props.setShowRhoOnState(event.target.checked)} />
                            Rho
                        </label>
                    </div>
