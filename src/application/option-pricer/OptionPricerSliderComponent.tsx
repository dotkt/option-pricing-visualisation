    ...
    render(): React.ReactNode {
        return (
            <div className={'slider-container'}>
                ...
                <div className={'slider-div'}>
                    <label className={'slider-label'}>Expiry Days: {this.props.expiryDays[this.props.buySell]} days</label>
                    <Slider
                ...
                <div className={'slider-div'}>
                    <label className={'slider-label'}>Volatility: {formatNumberToFixedDecimals(this.props.volatility[this.props.buySell]*100, 2)} %</label>
                    <Slider
                ...
                <div className={'slider-div'}>
                    <label className={'slider-label'}>Risk free rate: {formatNumberToFixedDecimals(this.props.riskFreeRate[this.props.buySell]*100, 2)} %</label>
                    <Slider
